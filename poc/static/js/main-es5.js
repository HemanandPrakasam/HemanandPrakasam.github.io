        ...
        value: function signUp() {
          ...
          if (this.signUpForm.status === 'VALID') {
            this.auth.checkIfAlreadyExists(this.signUpForm.value.id).subscribe(function (resData) {
              _this2.signUpFailure = true;
            }, function (error) {
              if (error.status === 404) {
                _this2.auth.createUser(_this2.signUpForm.value).subscribe(function (resData) {
                  _this2.auth.updateLoginStatus(resData);
        ...
        value: function updateUser(userdetail) {
          ...
          this.userDetails = this.userDetails.map(function (val, index) {
            if (val.id === userdetail.id) {
              _this3.userDetails[index] = userdetail;
            }
        ...
        value: function submit() {
          ...
          if (this.updateResgitrationDetailsForm.status === 'VALID') {
            this.auth.updateUser(this.updateResgitrationDetailsForm.value).subscribe(function (resData) {
              _this4.auth.updateLoginStatus(resData);
